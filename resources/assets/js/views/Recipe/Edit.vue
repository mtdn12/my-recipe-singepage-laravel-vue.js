...
<script>
    ...
    import {toFormData} from '../../helper/form'
    ...
    export default {
        ...
        created(){            
            get(`/api/recipes/${this.$route.params.id}/edit`)
                .then((res)=>{
        ...
        methods:{
            save(){
                ...
                put(`/api/recipes/${this.$route.params.id}`,this.form)
                    .then((res)=>{
                        if(res.data.updated){
                            Flash.setSuccess('Your recipe have been successfully updated.');
                ...
                if(typeof(this.form.image)!= 'string'){
                    ...
                    post(`/api/recipes/${this.$route.params.id}/image`,form)
                        .then((res)=>{
                            console.log(res);
                        })
                }              
